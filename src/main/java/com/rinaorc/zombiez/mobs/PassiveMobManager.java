...
public class PassiveMobManager implements Listener {
    ...
    // Limites globales - Réduites pour éviter la surpopulation
    private static final int BASE_MAX_MOBS_PER_ZONE = 5;
    private static final int MAX_MOBS_BONUS_HIGH_ZONES = 3; // Bonus pour zones 16+
    private int spawnCheckIntervalTicks = 400; // 20 secondes
    private double baseSpawnChance = 0.20; // 20% de chance par check
